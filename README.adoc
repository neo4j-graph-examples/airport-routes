:name: graph-data-science2
:long-name: Graph Data Science 2
:description: Leverage Neo4j Graph Data Science 2.0 library to explore graph algorithms for analytics and feature engineering.
...
:rendered-guide: https://guides.neo4j.com/sandbox/graph-data-science2/gds_browser_guide2.html
